 ...
 */
public class FenetreStatTauxSucces extends JFrame {
    /**
     * Le singleton (attribut static : attribut de la classe) qui intialisé à null
     */
    private static FenetreStatTauxSucces singleton = null;
     ...
     * @return signleton
     */
    public static FenetreStatTauxSucces getSingleton(JFreeChart freeChart) {
        if (singleton == null){
            singleton = new FenetreStatTauxSucces();
        }
     ...
     */
    private void initUI(){
        this.setTitle("Statistiques : Taux de succès par année scolaire");
